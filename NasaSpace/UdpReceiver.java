...
public class UdpReceiver implements Runnable {
    ...
    public UdpReceiver(int thePort, String broadcastIp,Object object)
    {
        port = thePort;
    ...
    public void receiveUDPMessage() throws
        ...
        while(!Thread.currentThread().isInterrupted()){
            try {
                ...
                //iStream.close();
                ReadPacket readPacket = new ReadPacket(packet.getAddress() ,Packet.generatePacketFromBytes(packet.getData(),packet.getOffset(),packet.getLength()),object);
